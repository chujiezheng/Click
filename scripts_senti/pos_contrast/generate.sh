...
generate.py \
    ...
    --model_name gpt2 \
    --pretrained_model_path checkpoints_senti/pos_contrast2_${model}/${alpha} \
    --save_path checkpoints_senti/pos_contrast2_${model}/${alpha} \
    --infer_data_paths data_senti/gpt2/neutral.txt data_senti/gpt2/negative.txt \
    --infer_names neutral negative \
    --only_generate \
    --max_input_length 15 \
